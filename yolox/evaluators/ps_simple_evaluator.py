...
class PSSEvaluator:
    ...
    def evaluate(
        ...
        for cur_iter, (imgs, _, info_imgs, ids) in enumerate(
            ...
            coco_format = self.convert_to_coco_format(outputs, info_imgs, ids)
...
#         print('save over !!!')
    ...
    def convert_to_coco_reid_format(self, outputs, reid_list, info_imgs, ids):
        image_list = []
        for (output,reid_feats, img_h, img_w, img_id) in zip(
            outputs,reid_list, info_imgs[0], info_imgs[1], ids
        ):
            data_list = []
            if output is None:
                pred_data = {
...
#             bboxes = xyxy2xywh(bboxes)
            ...
            for ind in range(bboxes.shape[0]):
                ...
                pred_data = {
                    ...
                    "reid_feat": reid_feats[ind].numpy(),
                    "segmentation": [],
                }  # COCO json format
